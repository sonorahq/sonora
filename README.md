...
| --- | --- | --- |
| English (`en-US`) | 661/661 | 100% |
| Deutsch (`de`) | 632/661 | 96% |
| Español (`es`) | 610/661 | 92% |
| Français (`fr`) | 632/661 | 96% |
| Italiano (`it`) | 610/661 | 92% |
| Bahasa Indonesia (`id`) | 610/661 | 92% |
| 日本語 (`ja`) | 610/661 | 92% |
| Русский (`ru`) | 656/661 | 99% |
| Українська (`uk`) | 656/661 | 99% |
| Polski (`pl`) | 650/661 | 98% |
| Português (Brasil) (`pt-BR`) | 610/661 | 92% |
| 简体中文 (`zh-CN`) | 610/661 | 92% |
| Türkçe (`tr`) | 610/661 | 92% |
