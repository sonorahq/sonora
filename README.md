...
| Deutsch (`de`) | 631/726 | 87% |
| Español (`es`) | 691/726 | 95% |
| Français (`fr`) | 637/726 | 88% |
| Italiano (`it`) | 609/726 | 84% |
| Bahasa Indonesia (`id`) | 609/726 | 84% |
| 日本語 (`ja`) | 609/726 | 84% |
| Русский (`ru`) | 711/726 | 98% |
| Українська (`uk`) | 711/726 | 98% |
| Polski (`pl`) | 711/726 | 98% |
| Português (Brasil) (`pt-BR`) | 609/726 | 84% |
| 简体中文 (`zh-CN`) | 609/726 | 84% |
| Türkçe (`tr`) | 609/726 | 84% |
