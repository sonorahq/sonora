...
settings-widevine-detail = Треки Apple Music зашифровані й потребують модуля Widevine від Google. Sonora бере копію, яка вже є в браузера.
settings-widevine-none = Треки Apple Music зашифровані й потребують модуля Widevine від Google. Він з'явиться на комп'ютері разом із Chrome, Edge, Brave або Firefox.
settings-widevine-looking = Пошук…
settings-widevine-installed = Знайдено на цьому комп'ютері
settings-widevine-missing = Не знайдено
