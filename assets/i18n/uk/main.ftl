...
login-sign-in-google = Увійти через Google
login-manual-sign-in = Використати ручний вхід
login-connect-cookies = Вставити cookie вручну
login-cookie-open = Відкрити YouTube Music
login-cookie-submit = Продовжити
login-manual-title = Увійти в YouTube Music вручну
login-manual-hint = Вставте сюди заголовок запиту
...
login-guest-continue = Продовжити як гість
