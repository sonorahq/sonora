...
settings-widevine-detail = Apple Music tracks are encrypted and need Google's Widevine module. Sonora uses the copy a browser here already has.
settings-widevine-none = Apple Music tracks are encrypted and need Google's Widevine module. Installing Chrome, Edge, Brave or Firefox puts one on this computer.
settings-widevine-looking = Looking…
settings-widevine-installed = Found on this computer
settings-widevine-missing = Not found
