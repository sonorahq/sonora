...
settings-global-hotkeys = Global hotkeys
settings-global-hotkeys-detail = Control playback while in games and background windows
settings-hotkey-play-pause = Play / Pause
settings-hotkey-play-pause-detail = Resume or pause playback
settings-hotkey-next = Next track
settings-hotkey-next-detail = Skip to the next track in the queue
settings-hotkey-previous = Previous track
settings-hotkey-previous-detail = Return to the previous track
settings-hotkey-stop = Stop
settings-hotkey-stop-detail = Stop playback completely
settings-hotkey-volume-up = Volume up
settings-hotkey-volume-up-detail = Increase playback volume
settings-hotkey-volume-down = Volume down
settings-hotkey-volume-down-detail = Decrease playback volume
settings-hotkey-recording = Press a shortcut...
