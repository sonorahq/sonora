...
settings-lyrics-for-local-files = Online lyrics for local files
settings-lyrics-for-local-files-detail = If local lyrics aren't available, use track metadata to fetch lyrics from the internet
