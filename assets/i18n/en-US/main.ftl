...
settings-discord-rpc = Show on Discord
settings-discord-rpc-detail = Show the current track as your Discord status while it's playing
settings-discord-hide-details = Hide track details
settings-discord-hide-details-detail = Show "Listening to music" on Discord instead of the track title and artist
discord-listening-generic = Listening to music
