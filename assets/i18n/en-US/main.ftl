...
settings-scrobbling = Send plays to Last.fm, Libre.fm and ListenBrainz
settings-scrobbling-detail = Connect any service to log every track you finish
settings-lastfm-api-key-hint = Last.fm API key
settings-lastfm-api-secret-hint = Last.fm shared secret
settings-lastfm-api-create = Create a Last.fm API account
settings-lastfm-connect = Connect Last.fm
settings-lastfm-confirm = I've authorized
settings-lastfm-disconnect = Disconnect
settings-librefm-api-key-hint = Libre.fm API key
settings-librefm-api-secret-hint = Libre.fm shared secret
settings-librefm-api-create = Create a Libre.fm API account
settings-librefm-connect = Connect Libre.fm
settings-librefm-confirm = I've authorized
settings-librefm-disconnect = Disconnect
...
toast-librefm-connected = Connected to Libre.fm as { $name }
toast-librefm-failed = Could not connect to Libre.fm
