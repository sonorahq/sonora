...
login-sign-in-google = Войти через Google
login-manual-sign-in = Использовать ручной вход
login-connect-cookies = Вставить cookie вручную
login-cookie-open = Открыть YouTube Music
login-cookie-submit = Продолжить
login-manual-title = Войти в YouTube Music вручную
login-manual-hint = Вставьте сюда заголовок запроса
...
login-guest-continue = Продолжить как гость
