...
settings-global-hotkeys = Глобальные горячие клавиши
settings-global-hotkeys-detail = Управление воспроизведением в играх и фоновом режиме
settings-hotkey-play-pause = Воспроизведение / Пауза
settings-hotkey-play-pause-detail = Возобновить или приостановить трек
settings-hotkey-next = Следующий трек
settings-hotkey-next-detail = Перейти к следующему треку в очереди
settings-hotkey-previous = Предыдущий трек
settings-hotkey-previous-detail = Вернуться к предыдущему треку
settings-hotkey-stop = Остановка
settings-hotkey-stop-detail = Полностью остановить воспроизведение
settings-hotkey-volume-up = Увеличить громкость
settings-hotkey-volume-up-detail = Сделать воспроизведение громче
settings-hotkey-volume-down = Уменьшить громкость
settings-hotkey-volume-down-detail = Сделать воспроизведение тише
settings-hotkey-recording = Нажмите комбинацию клавиш...
settings-hotkey-reset = Сбросить по умолчанию
