...
settings-widevine-detail = Треки Apple Music зашифрованы и требуют модуля Widevine от Google. Sonora берёт копию, которая уже есть у браузера.
settings-widevine-none = Треки Apple Music зашифрованы и требуют модуля Widevine от Google. Он появится на компьютере вместе с Chrome, Edge, Brave или Firefox.
settings-widevine-looking = Поиск…
settings-widevine-installed = Найден на этом компьютере
settings-widevine-missing = Не найден
