...
settings-output-latency = Retard de sortie
settings-output-latency-detail = Le retard de vos enceintes sur l'application. La barre de lecture et les paroles reculent d'autant, pour suivre ce que vous entendez.
settings-output-latency-value = { $seconds } s
settings-airplay-latency = Détecter AirPlay
settings-airplay-latency-detail = Applique les deux secondes propres à AirPlay tant qu'il est la sortie, à la place du réglage ci-dessus
...
settings-group-latency = Latence
