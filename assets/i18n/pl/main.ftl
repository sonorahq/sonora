...
settings-widevine-detail = Utwory Apple Music są zaszyfrowane i potrzebują modułu Widevine od Google. Sonora używa kopii, którą ma już przeglądarka.
settings-widevine-none = Utwory Apple Music są zaszyfrowane i potrzebują modułu Widevine od Google. Pojawi się on na komputerze razem z Chrome, Edge, Brave albo Firefoksem.
settings-widevine-looking = Szukanie…
settings-widevine-installed = Znaleziony na tym komputerze
settings-widevine-missing = Nie znaleziono
