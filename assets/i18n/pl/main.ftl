...
login-sign-in-google = Zaloguj się przez Google
login-manual-sign-in = Użyj logowania ręcznego
login-connect-cookies = Wklej pliki cookie ręcznie
login-cookie-open = Otwórz YouTube Music
login-cookie-submit = Kontynuuj
login-manual-title = Ręczne logowanie do YouTube Music
login-manual-hint = Wklej tutaj nagłówek żądania
...
login-guest-continue = Kontynuuj jako gość
