...
login-sign-in-google = Iniciar sesión con Google
login-manual-sign-in = Usar inicio de sesión manual
login-connect-cookies = Usar inicio de sesión manual
login-cookie-open = Abre YouTube Music
login-cookie-submit = Continuar
login-manual-title = Usar un inicio de sesión manual de YouTube Music
login-manual-hint = Pega aquí el encabezado de solicitud
...
login-cookie-title = Usar un inicio de sesión manual de YouTube Music
login-window-title = Iniciar sesión en { $provider }
login-use = Usar { $provider }
login-guest-title = Modo invitado
login-guest-continue = Continuar como invitado
